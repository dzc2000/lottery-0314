package com.dzc.trigger.http;

import com.alibaba.fastjson.JSON;
import com.dzc.domain.activity.model.entity.ActivityAccountEntity;
import com.dzc.domain.activity.model.entity.UserRaffleOrderEntity;
import com.dzc.domain.activity.service.IRaffleActivityAccountQuotaService;
import com.dzc.domain.activity.service.IRaffleActivityPartakeService;
...
import com.dzc.domain.strategy.model.entity.RaffleAwardEntity;
import com.dzc.domain.strategy.model.entity.RaffleFactorEntity;
import com.dzc.domain.strategy.service.IRaffleStrategy;
import com.dzc.domain.strategy.service.armory.IStrategyArmory;
import com.dzc.trigger.api.IRaffleActivityService;
import com.dzc.trigger.api.dto.ActivityDrawRequestDTO;
import com.dzc.trigger.api.dto.ActivityDrawResponseDTO;
import com.dzc.trigger.api.dto.UserActivityAccountRequestDTO;
import com.dzc.trigger.api.dto.UserActivityAccountResponseDTO;
...
public class RaffleActivityController implements IRaffleActivityService {
     ...
     * 判断是否签到接口
     * <p>
     * curl -X POST http://localhost:8091/api/v1/raffle/activity/is_calendar_sign_rebate -d "userId=dzc" -H "Content-Type: application/x-www-form-urlencoded"
     */
