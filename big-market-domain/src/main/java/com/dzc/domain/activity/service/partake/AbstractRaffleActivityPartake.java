package com.dzc.domain.activity.service.partake;
...
import com.dzc.domain.activity.model.entity.PartakeRaffleActivityEntity;
import com.dzc.domain.activity.model.entity.UserRaffleOrderEntity;
import com.dzc.domain.activity.model.valobj.ActivityStateVO;
...
public abstract class AbstractRaffleActivityPartake implements IRaffleActivityPartakeService {
    ...
    public UserRaffleOrderEntity createOrder(PartakeRaffleActivityEntity partakeRaffleActivityEntity) {
        ...
        log.info("创建活动抽奖单完成 userId:{} activityId:{} orderId:{}", userId, activityId, userRaffleOrder.getOrderId());        // 7. 返回订单信息
